...
public class BoundingBox {
	...
	/*this function was edited (< and > was changed to <= and >=) 
	 * as previously the player would die if directly behind or in front of a bus.
	 * With this change the player can stand behind and in front of a bus or water tile
	 * without dying*/
