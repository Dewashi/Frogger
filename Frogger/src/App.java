...
public class App extends BasicGame {
    ...
    public void update(GameContainer gc, int delta)
        ...
        endGame = world.update(world, input, delta);
    ...
    public void render(GameContainer gc, Graphics g)
            throws SlickException {
    	/*Renders all objects in world*/
    	if (endGame == true) {
    		world = new World();
    		levelNum += 1;
    		endGame = false;
    		System.out.print("next lvl \n");
    	}
    	if (levelNum == 0) {
    		
    		world.initialise(world, "assets/levels/0.lvl"); 
        }
    	if (levelNum == 1) {
    		
    		world.initialise(world, "assets/levels/1.lvl"); 
        }
    	if (levelNum == 2) {
